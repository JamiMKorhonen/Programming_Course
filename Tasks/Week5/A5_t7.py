...
# Word collecting:
# Prompt user to insert word. 
# Repeat the prompt till the user enters an empty word. 
...
def alanyseWords(words):

    commas = words.count(",")
    wordcount = commas + 1

    totalchars = len(words)
    wordchars = totalchars - commas

    avg = wordchars / wordcount

    print(f"- {wordcount} Words")
    print(f"- {wordchars} Characters")
